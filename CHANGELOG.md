...
## [2.0.0](https://github.com/metonym/svelte-intersection-observer/releases/tag/v2.0.0) - 2026-07-04
...
- Add `use:intersect` action (#114)
- Add `skip` support for `IntersectionObserver`, `MultipleIntersectionObserver`, and `use:intersect`

**Performance**

- Batch `Map` reassignment per callback in `MultipleIntersectionObserver` (#116)
